...
\section{Prospectives}
    ...
    \subsection{Multiple-stellar populations, Stellar evolution, and globular cluster formation and internal dynamics, stellar populations}
        ...
        Globular clusters, are peculiar objects and besides being massive star clusters, they also have peculiar chemical abundance patterns compared to typical galactic field stars \citep{2012A&ARv..20...50G,2018ARA&A..56...83B,2019A&ARv..27....8G}. The stars within the clusters are mostly expected to be second generation stars, implying that the original cluster formed as being much more massive, although no single globular cluster formation and evlution scenario successfully reproduces all chemical abundance patterns. Some studies are investigating methods for dynamically creating a second generation. For example, \citet{2024A&A...681A..45L}, investigated a scenario in which a second generation of stars, forms within a globular cluster from a gaseous disk, which eventualy relaxes to a spherical distribution of the second generation of stars and the authors indeed find that the final mass can 20x less massive than the initial mass so that the globular cluster finishes with roughly equal parts of gen II and gen I. Note that in this scenario, the stelalr stream, or the material ejected from the globular cluster, is predominantly generation I. 

        While people are exploring dynamical models with stellar evolution, people are also turning to the observations. For example, \citet{2025MNRAS.537.2342C} has enough data to measure the difference in kinematic patterns between two different generation of stars within 47-Tuc. 

        The chemical composition of the stars within globular clusters is a key for the Galactic assembly history. Specifically, their chemical abundance patterns are distinct from stars within the Galactic disk. Not only this, but the stars within the Milky Way's halo follow similar abundance patterns to the globular clusters \citep{2016ApJ...825..146M,2017MNRAS.465..501S}.  The ex-cluster stars aren't limited to the halo. For instance \citet{2021ApJ...918L..37F} sound some metal rich cluster debris (still sub-solar metallicities) within the galactic disk. Simmilarly, \citet{2017ApJ...846L...2F} found 11 stars with the chemical abundance patterns of second general stars within globular cluster within the Milky Way's disk. 
        
        Not only is the data quality getting good enough to study the kinematics within the globular clusters, but people are investigating the multiple stellar populations within the stellar streams. 

        \citet{2022MNRAS.510.3727P} talks about nitrogen rich stars in the Palomar 5 tails. Nitoegran rich stars are markers of halo stars. \citet{2024MNRAS.529.2413U} said that there's evidence of multiple populations within the stellar streams. Something expected and now observationally confirmed. This stream was not associated with any globular cluster. However, by having a large enougn sample size and the chemical abundances, they were able to discern that it was from a globular cluster. Not only this but they found one star with chemical abundance patterns with that of a second generation globular cluster star. 

        In the coming years, with more chemical abundances with more stars in the tidal tails, we may begin probing the distribution of generation 1 and generation 2 stars. Their kinematics within the stream may be tied to the internal dynamical evolution. 

\section{final word}
    Stellar streams and globular clusters \dots 
