...
\section{Prospectives}
    ...
    \paola{quello che scrivo qui e' uno dei miei punti preferiti. Quello che dici sulla DM e' tutto vero, pero' ti ricordo che non abbiamo ancora messo tutti gli streams in potenziali granulari solo per effetto barionico: quanto streams mostrerebbero gaps se immersi nel sistema di tutti gli AG? e se aggiungiamo le GMG? non devi scrivere tutto, pero' per me e' una tipica estensione di quello che hai fatto nel 2025 e che andra' fatta. }
    ...
    \subsection{The bulk gravitational field of the MW}
        ...
        The total mass, orientation, and length of the bar have been constrained in previous studies, though significant uncertainties remain. Most notably, the bar pattern speed (its angular velocity) still has two plausible regimes: slow or fast rotation \citep{2015MNRAS.450.4050W,2016ARA&A..54..529B,2023MNRAS.520.4779L,2024MNRAS.528.3576V} \paola{and also a pattern speed which can vary with time (see for ex the work by Misha, this year, about the time of bar formation and resonances moving through the disk. }
    ...
    \paola{questa sezione ha bisogno di essere ancora un po' lavorata.}
