...
\section{Prospectives}
    ...
    \paola{questa sezione ha bisogno di essere ancora un po' lavorata.}
        ...
        With improving data quality, it is now possible to trace multiple stellar populations beyond the clusters themselves, into their tidal debris \citep{\citet{2022MNRAS.510.3727P}}. For example, \citet{2024MNRAS.529.2413U} found evidence for multiple populations within a stellar stream not linked to any known cluster. From detailed chemical abundances, they were able to identify the stream as globular cluster debris, even uncovering a star with the distinct chemical fingerprint of a second-generation population.

        In the coming years, as chemical abundance measurements are obtained for more stars in tidal tails, we may be able to map the spatial distribution of first and second generation stars in streams. Their relative kinematics could offer a direct probe of the progenitor cluster's internal dynamical evolution.
