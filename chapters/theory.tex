...
\begin{itemize}
    \item \textbf{Explicit physics}: These are the fundamental equations that underpin our models. the physical laws and initial conditions implemented in the simulations;
