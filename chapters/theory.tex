...
\section{The Implicit Physics}
    ...
    \subsection{The Planar Circular Restricted Three-Body Problem}
        ...
        We have been asked at conference is we have ever witnessed \textit{recapture}, i.e. a star particle leaving a globular cluster and eventually returning. If the problem were as simple as the circular-restricted three body problem, recapture would imply a star-particle whose energy is either between $E_1<E<E_2$ or $E_2<E<E_3$. In these cases, depending on the initial conditions, a particle may orbit about the secondary, leave, and eventually come back. 

        However, for our simulations, the galaxy and globular clusters are not point masses, and the clusters are on eccentric, inclined, and have non-closed orbits. This means that the forbidden region changes as a function of time. For a given particle of Energy E, it is possible that in one instant of the simulation it's energy is sufficient to go beyond. It is then also possible that the particle can come back, the and the forbidden region can grow and ensure that it remains on the inside. We have witnessed this in our simulations. 

        The lagrange points, forbidden regions, and jacobi energy are powerful concepts that, while they do not rigorously extend to our simulations, qualitatively they do given the complexity of our orbits and gravitational potential. In this regime, it is more insightful to think of tidal forces as the underlying mechanism that gradually transfers energy and angular momentum, nudging stars across the Lagrange boundaries and ultimately driving escape. It is to this process—tidal stripping—that we now turn.
