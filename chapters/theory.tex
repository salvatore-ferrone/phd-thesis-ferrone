...
\section{The Explicit Physics}
    ...
    \subsection{The initial conditions}\label{subsec:initialconditions}
        ...
        \subsubsection{Inverse Transform Sampling}
            With the distribution funciton in hand, how do we sample it to a set of discrete particles? There are many techniques that exist. I choose inverse transform sampling as it was covered my course work. 
