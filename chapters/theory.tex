...
\section{The Implicit Physics}
    ...
    \subsection{Massive objects colliding with stellar streams}
        ...
        \subsubsection{Gap formation and evolution}
            ...
            \paola{tutta questa parte mi sembra ottima. Quello che forse manca, qui o nelle conclusioni (che devo ancora leggere) e' lo studio che hai fatto per il paper 2, sulla visibilita' dei gaps in streams caratterizzati da popolazioni di stelle perse a tempi diversi, con velocita' medie diverse. Credo (ma devo finire di leggere tutto) che a questo lavoro non accenni nella tesi. Non so se e' a questo che pensi quando parli qui sopra di 'eccentric mass loss'.. }
