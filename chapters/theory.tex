...
\section{The Explicit Physics}
    ...
    \subsection{The Gravitational Field} \label{subsec:gravfield}
        ...
        The second Galactic potential model presented in \citet{2017MNRAS.465...76M} consists of two Miyamoto-Nagai disks plus the Martos halo and is shown in Fig.~\ref{fig:figure_pouliasis2017pii_potential}. More visualizations of this potential can be found in their work.
        \begin{figure}
            \centering
