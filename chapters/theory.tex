...
\section{The Ignored Physics} \label{sec:ignoredphysics}
    ...
    \subsection{Globular Cluster Internal Dynamics} \label{sec:collisionalDynamics}
        In this thesis, globular clusters are the \textit{source} for stellar streams, because we are interested in stellar streams more than we are interseted in the globular clusters. We simplified the orbits of stars within clusters to feel the mean-field, knowing full well that this is a limiting assumption. We traded computational speed for accuracy. However, how much of a limiting assumption is this? 
        \subsubsection{Two-body relaxation time, derivation and example}
            ...
            \subsubsection{Other collisional dynamics}
            The two body relaxation time of how long it takes for an orbit to go off-traack due to the 
