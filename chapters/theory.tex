...
\section{The Explicit Physics}
    ...
    \subsection{The Gravitational Field} \label{subsec:gravfield}
        ...
        Another way of modeling the Milky Way is that of \citet{2023MNRAS.520.1832B}, who assumed an axis-symmetr

        Then, there are models that are more aligned with the scientific goals of this thesis, namely, accurately computing orbits for bodies within the galaxy. i.e., those that are purely dynamically motivated and the stellar populations are a lower priority. For example, in the presentation of Galpy, \citet{2015ApJS..216...29B} presents a gravitational potential that satisfies a varity of observational constraints, which are listed in secton 3.5, and these constraints discuss satisfy observations of the stellar kinematics within the local solar volume as well as some measurements about the rotation curve. 
