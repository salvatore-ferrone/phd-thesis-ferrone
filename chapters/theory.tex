...
\section{The Implicit Physics}
    The previous section describes everything necessary for simulating the dissolution of globular clusters. However, given the equations of motions, model for the gravitational field, and and initial conditions for the globular clusters and the stars within then, why do we expect the stars to escape? While the formalisms presented in the previous section admit the equations necessary to produce simulations, they do not instruct us on to why this happens. 

    In this section, I aim to explain the mechanisms that that demonstrate why stars escape from the globular clusters and then subsequently create stellar streams. To gain an intuition to this process, in essence, it involves simplifying the equations \textit{even further} to gain analytical insight. This is why I named the section \textit{implicit physics}, which is because I did not include this into the simulation, but emerges naturally from the equations that I explicitly included and presented in the last section. 

    To give a brief overview to this section, I present the circular restricted three body problem, which is the simplest formalism for understanding the three body problem and different types of motion a tiny-massless body can experience when subject to two much larger bodies. Then, I present the tidal tensor, which explains why and how the galactic field eventually pushes the stars outside of the clusters. Then I present phase-mixing, which serves to explain what happens to the star-particles once they escape. This chapter additionally serves to explain the differences in orbital solutions, since phase mixing explains why stars in a stream spread with time as well as why the uncertainties grow in time between different possible orbital solutions. The differences in orbital solutions is indeed very important for the work of Chapter~5 where we investigate the if the globular cluster system can impact Palomar~5's stream. Lastly, I present \textit{gapology} which explains the physical mechanisms of how a pertuber can impact a stream to subsequently create a gap within it.  
