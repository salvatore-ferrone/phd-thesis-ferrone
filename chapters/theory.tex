...
\section{The Explicit Physics}
    ...
    Throughout this thesis, I have access to the Paris observatory's super computer \citep[tycho]{DIO_OBSPM}\paola{questa citazione non appare bene. perche' non mettere semplicemente una footnote con l'indirizzo della pagina web?}, which currently has about 85 nodes. However, as a humorous aside, consider attempting this computation on a personal research laptop, such as a MacBook Air with an M2 processor. Its estimated speed of $\sim$0.1 TFLOPS (i.e., $10^{11}$ FLOPS) \citep{hubner2025apple} is approximately 10 million times slower than Frontier. A single time step would thus take over 1,500 years.
    ...
    \subsection{Equations of Motion} \label{subsec:myEquationsOfMotion}
        ...
        \end{equation}  
        $M_{\mathrm{gc}}$ is the mass of the globular cluster, $m$ is the mass of a star, $\mathbf{R}_{\mathrm{gc}}$ is the galacto-centric position of the globular cluster, $r$ is the galacto-centric position of the star, $\Phi_{\rm gal}$ is the potential of\paola{generated by?} the galaxy and $\Phi_{\mathrm{gc}}$ is the potential of\paola{generated by?} the globular cluster. We decouple the equations of motion of the globular cluster and the star. The justification for this approximation is evident when we normalize the Lagrangian by the cluster mass. This yields:
        \begin{equation}
    ...
    \subsection{The Gravitational Field} \label{subsec:gravfield}
        ...
        In this thesis, we use the models of \citet{2017A&A...598A..66P}, which build upon the work of \citet{1991RMxAA..22..255A}. These models were developed within our research group and were available at the start of the project. They were designed to fit observational data similar to those used in \citet{2015ApJS..216...29B}, including the Galactic rotation curve and local stellar kinematics. \citet{2017A&A...598A..66P} were motivated to create a new Galactic model that included a thick disk, as \citet{2013A&A...560A.109H} and \citet{2015A&A...578A..87S} demonstrated, based on chemical abundance patterns, the existence of two distinct stellar populations. \citet{2017A&A...598A..66P}\paola{scritto cosi' non e' corretto. L'esistenza del disco spesso e' nota dagli anni 80 (vedi Gilmore \& Reid 1986. Quello che abbiamo detto in Haywood+2013 e Snaith+2014, 2015 e' che il disco spesso della galassia e' massiccio, comparabile in massa al disco fino. Cosa nuova all'epoca, perche' il disco spesso era visto (e da alcuni lo e' ancora) come una componente in massa minoritaria nella Galassia. QUindi quello che devi dire e' che la motivazione del lavoro di Pouliasis era di costruire un modello, simile a quello di A\&S 91, ma che includesse un disco spesso massiccio. Per info: ALl'epoca, A\&S91 era il modello ancora + usato per l'intregrazione delle orbite, e quindi aveva senso e interesse fare un update di quel modello. La ragione per cui abbiamo poi sviluppato due modelli, uno con bulge e uno senza viene dal fatto che un bulge classico (= sferico) nella nostra Galassia non esiste, almeno non con la massa usata da A\&S91. Il rigonfiamento centrale nella nostra Galassia e' essenzialmente dovuto alla barra. } thus provide two Milky Way potential models: one with a bulge and one without. Below, we describe the second version, which is used in both Chapter~4 and Chapter~5.
