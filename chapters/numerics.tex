...
\section{Numerical Error \& Computation Time}
    ...
    \subsection{Globular Cluster Orbits in a Static Galaxy}
        ...
        Fig.~\ref{fig:numericalErrorLeapFrogVanilla} shows the numerical error computed for all $165$ globular clusters for $5$~Gyr, with two different time steps: $10^4$ and $10^7$ years. 
        \begin{figure}
            \centering
