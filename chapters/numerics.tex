...
\section{Numerical error}
    ...
    \begin{itemize}
        \item what's the right time step? 
        \item dynamical time 
        \item compute the energy conservation 
        \item reverse integratbility
        \item throwing outdata and then re-interpolating 
        \item show some nice graphs 
    \end{itemize}
