...
\section{Numerical Error \& Computation Time}
    ...
    \subsection{Star particle integration}
        ...
        \begin{figure}
            ...
            \caption{Numerical error of a plummer sphere by using different timesteps that are different fractions of the internal dynamical time.}
        ...
        \begin{figure}
            ...
            \caption{The time-reversability of a cluster in our simulations. Not perfect but good enough, particularly when considering the computational cost.}
            \label{fig:images/NumericalErrorStreamRetrace_Pal5_Nsteps_32768_stepsPerTau_420}
        \end{figure}
