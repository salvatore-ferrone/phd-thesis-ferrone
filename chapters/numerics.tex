...
\section{Astronomical units and scaling}
    ...
    \begin{equation}
        1\frac{\mathrm{kpc}}{Gyr} \approx 1\frac{km}{s}.
    \end{equation}

    The gravitational constant has dimensions of:
    \begin{equation}    
        \left[G\right]=\frac{v^2 l}{m}
    \end{equation} 
    ...
    This approach was used in our first paper, but I have opted against it in subsequent work for reasons of interpretability.
