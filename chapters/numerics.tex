...
\section{Solving the equations of motion}
    ...
    \begin{table}[h]
    % \paola{non so cosa suggerirti esattamente, ma trovo che le tabelle siano un po' confuse con il testo, ovvero che quando si legge il testo e si trova una teblla nel mezzo, non si capisce bene dove ricomincia poi il testo e dove finisce la tabella .. non so se hai un modo di migliorare questa cosa. non e' un problema maggiore, ma se hai tempo per farlo (per tutte le tabelle ..)}
        \centering
