...
\section{Numerical Error and Computation Time}
    ...
    At this stage, I did not have time to perform a full quality check of orbits within the barred potential. However, I refer the reader to the \texttt{tstrippy} documentation, where I demonstrate the time-reversibility of cluster orbits in the barred potential: \href{https://tstrippy.readthedocs.io/en/latest/reverse_integrability_bar.html}{https://tstrippy.readthedocs.io/en/latest/reverse_integrability_bar.html}.
